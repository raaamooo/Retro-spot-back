...
class BookingService {
    ...
    async isTimeSlotAvailable(date, startTime, endTime) {
     ...
     */
    async updateBookingStatus(bookingId, newStatus, paymentStatus) {
        ...
        this.io.emit(socketEvents_1.EVENTS.BOOKING_STATUS_UPDATED, booking);
